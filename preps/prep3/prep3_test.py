...
class test_salaried_employee(unittest.TestCase):
    def test_one_month(self):
        ...
        expect = 500
        actural = a.total_pay()
        self.assertEqual(expect, actural, "The employee has one moth payment")
    ...
    def test_two_months(self):
        ...
        expect = 2000
        actural = b.total_pay()
        self.assertEqual(expect, actural, "The employee has two months payment")
...
class test_hour_salaried(unittest.TestCase):
    def test_one_month(self):
        ...
        expect = 500
        actural = a.total_pay()
        self.assertEqual(expect,actural,"The hour employee only payed once")
    ...
    def test_two_months(self):
        ...
        expect = 2000
        actural = b.total_pay()
        self.assertEqual(expect, actural, "The hour employee has payed twice")
...
class test_total_payroll(unittest.TestCase):
    def test_one_salaried_employee_1(self):
        ...
        expect = 2000
        actural = a.total_payroll()
        self.assertEqual(expect, actural, "There is a salaried employee paied 2000")
    ...
    def test_one_salaried_employee_2(self):
        ...
        expect = 6000
        actural = a.total_payroll()
        self.assertEqual(expect, actural, "There is a salaried employee paied 6000")

    def test_one_hourly_employee(self):
        b = Company([HourlyEmployee(6,"c",20,30)])
        b.pay_all(date(2018, 10, 28))
        expect = 600
        actural = b.total_payroll()
        self.assertEqual(expect, actural, "There is a hourly emplyee paied 600")
    ...
    def test_one_hourly_employee_2(self):
        ...
        expect = 1000
        actural = b.total_payroll()
        self.assertEqual(expect, actural, "There is a hourly employee paied 1000")

    def test_mixed_employee(self):
        c = Company([SalariedEmployee(4,"a", 12000), HourlyEmployee(5,"b",20, 50)])
        c.pay_all(date(2019, 1, 28))
        expect = 2000
        actural = c.total_payroll()
        self.assertEqual(expect, actural, "There is a salaried employee and a hourly employee")

    def test_mixed_employee_2(self):
        c = Company([SalariedEmployee(5, "b", 12000), HourlyEmployee(6, "c",20, 50)])
        c.pay_all(date(2019, 2, 28))
        c.pay_all(date(2019, 3, 28))
        expect = 4000
        actural = c.total_payroll()
        self.assertEqual(expect, actural, "There is a salaried employee and a hourly employee paid twice")
