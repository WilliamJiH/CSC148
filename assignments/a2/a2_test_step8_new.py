...
class TestCreateCopy(A2Test):
    ...
    def test_copy_leaf(self):
        ...
        exp_list = [getattr(self.leaf_block, attr_name) for attr_name in
                    self.block_attrs]
    ...
    def test_copy_one_level(self):
        ...
        self.assertBlock(copy.children[0], [(5, 0), 5, (20, 20, 20), 1, 1, 0],
                         True, True)
        self.assertBlock(copy.children[1], [(0, 0), 5, (30, 30, 30), 1, 1, 0],
                         True, True)
        self.assertBlock(copy.children[2], [(0, 5), 5, (40, 40, 40), 1, 1, 0],
                         True, True)
        self.assertBlock(copy.children[3], [(5, 5), 5, (50, 50, 50), 1, 1, 0],
                         True, True)
    ...
    def test_copy_one_internal(self):
        ...
        self.assertBlock(copy.children[0], [(50, 0), 50, None, 1, 2, 4], True,
                         False)
        self.assertBlock(copy.children[1], [(0, 0), 50, (80, 80, 80), 1, 2, 0],
                         True, True)
        self.assertBlock(copy.children[2], [(0, 50), 50, (70, 70, 70), 1, 2, 0],
                         True, True)
        self.assertBlock(copy.children[3],
                         [(50, 50), 50, (60, 60, 60), 1, 2, 0], True, True)
        self.assertBlock(copy.children[0].children[0],
                         [(75, 0), 25, (40, 40, 40), 2, 2, 0], True, True)
        self.assertBlock(copy.children[0].children[1],
                         [(50, 0), 25, (30, 30, 30), 2, 2, 0], True, True)
        self.assertBlock(copy.children[0].children[2],
                         [(50, 25), 25, (20, 20, 20), 2, 2, 0], True, True)
        self.assertBlock(copy.children[0].children[3],
                         [(75, 25), 25, (10, 10, 10), 2, 2, 0], True, True)
...
class A2TestPlayerTopLevel(A2Test):
    ...
    def test_smart_player_paint(self):
        ...
        self.assertEqual('paint', move[0],
                         "The only valid move for a leaf is paint")
    ...
    def test_smart_player_rotate_1(self, mock_paint, mock_smash, mock_swap):
        ...
        self.set_children(temp.children[2],
    ...
    def test_smart_player_rotate_2(self, mock_paint, mock_smash, mock_swap):
        ...
        temp = Block((0, 0), 100, None, 0, 2)
        self.set_children(temp, [(i, i, i) for i in range(10, 50, 10)])
        self.set_children(temp.children[1],
